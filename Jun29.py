...
def main():
    ...
    def clicked():
        ...
        window_sign_up.geometry("700x500")
        ...
        def submit():
            ...
            fig.add_shape(type='line', 
                ...
                line_dash='dot', 
                line_width=1, 
                x0=0, x1=len(data['x']), xref='x1', y0=mrUCL_b, y1=mrUCL_b, yref='y2', 
                secondary_y=True)
            fig.add_shape(type='line', 
                line_color='LightSeaGreen',
                line_dash='dot', 
                line_width=1, 
                x0=0, x1=len(data['x']), xref='x1', y0=mrUCL_c, y1=mrUCL_c, yref='y2', 
                secondary_y=True)
            fig.add_shape(type='line', 
                line_color='LightSeaGreen', 
                line_width=1, 
            ...
            fig.add_shape(type='line', 
                ...
                line_dash='dot', 
                line_width=1, 
                x0=0, x1=len(data['x']), xref='x1', y0=mrLCL_c, y1=mrLCL_c, yref='y2', 
                secondary_y=True)
            fig.add_shape(type='line', 
                line_color='crimson', 
                line_width=1, 
        ...
        l_mean.grid(row=3,sticky=W)
        l_sd =Label(frameTwo,text='标准差：',state=DISABLED)
        l_sd.grid(row=4,sticky=W)
        #Section One
        ...
        r_params_second.grid(row=2,sticky=W)
        l_params =Label(frameTwo,text='参数：')
        l_params.grid(row=0,sticky=W)
        ...
        l_tests.grid(row=0,sticky=W)
        r_value_display = StringVar()
        r_value_display.set("testOne")
        r_tests_second = Radiobutton(frameThree, text="执行所有特殊测试", variable=r_value_display, value="all tests")
        r_tests_second.grid(row=3,sticky=W)
        r_tests = Radiobutton(frameThree, text="仅执行测试1(1 point > 3 standard deviations from the center line)", variable=r_value_display, value="testOne")
        r_tests.grid(row=2,sticky=W)
        r_tests_third = Radiobutton(frameThree, text="仅执行测试1、5、6、8", variable=r_value_display, value="part of tests")
        r_tests_third.grid(row=4,sticky=W)
        r_tests_four = Radiobutton(frameThree, text="不执行测试", variable=r_value_display, value="no tests")
        r_tests_four.grid(row=5,sticky=W)
        l_tests =Label(frameThree,text='特殊测试：')
        l_tests.grid(row=1,sticky=W)
        #Section Two
        c_value_1 = "1sd"
        c_value_2 = "2sd"
        l_additional =Label(frameThree,text='显示额外的在中心线上下的标准差限制')
        l_additional.grid(row=6,sticky=W)
        c_additional = Checkbutton(frameThree, text="1标准差", variable=c_value_1, command=show_options)
        c_additional.grid(row=7,sticky=W)
        c_additional_second = Checkbutton(frameThree, text="2标准差", variable=c_value_2, command=show_options)
        c_additional_second.grid(row=8,sticky=W)
